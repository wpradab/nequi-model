...
def get_secret(secret_name="prod/app/tweets", region_name="us-east-1"):
    """
    Devuelve un diccionario con las credenciales almacenadas en Secrets Manager.
    """
    ...
    try:
        ...
        # Si el secreto es un string JSON, lo decodificamos
